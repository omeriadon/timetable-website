...
export default function AdminEmailLogEditor() {
	...
	return (
		<main className={styles.page}>
			...
			{entries === null && !error ? <p className={styles.loading}>Loading email log…</p> : null}
			{entries?.length === 0 ? <p className={styles.emptyRow}>No email deliveries have been recorded.</p> : null}
			{entries?.length ? (
